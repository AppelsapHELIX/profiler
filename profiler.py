...
while True:
    ...
    print(colored("[", "red", attrs=['bold']) + colored("3", "white", attrs=['bold']) + colored("]", "red", attrs=['bold']) + " " + colored("License Plate Database", "white", attrs=['bold']))
    print("")
    ...
    if menu == "1":
        ...
        print(colored("Feature Coming Soon", "white", attrs=['bold']) + colored("!", "red", attrs=['bold']))
